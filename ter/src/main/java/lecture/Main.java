...
public class Main {
	public static void main(String[] args){
		...
		System.out.println(test.p.trans.get(1).listeCellule.get(1).etat.get(0) + "/" + test.p.trans.get(1).listeCellule.get(1).etat.get(1) + "/" + test.p.trans.get(1).date);
		//System.out.println(test.p.resultat);
	}
}
